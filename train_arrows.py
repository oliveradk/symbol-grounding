...
def train_ppo_arrows(model_name="ppo_arrows", time_steps=3e5, log_freq=1000, verbose=1):
    train_ppo_gridworld(env_name="MiniGrid-ArrowsRandomS5-v0", model_name=model_name,
